import git
#git.Git().clone("https://github.com/Sam6734/TwitchViewbot.git")
#git.Git().clone("https://github.com/ShiftyTR/Proxy-List.git")
...
#desired channel url
channel_url = 'https://www.twitch.tv/mondevert'
#number of viewer bots
botcount = 10
#path to proxies.txt file
proxypath = r'A:\MondeVert\MondeVert\Utilities\proxy.txt'
#path to vlc
