...
Original_List_of_Voices_ESL= ['Lupe**','Hiujin','Zhiyu','Léa','Gabrielle','Bianca','Ida','Ola','Camila','Vitória/Vitoria','Inês/Ines','Lucia','Mia','Hala*','Arlet','Laura','Suvi','Vicki','Hannah','Kazuha','Tomoko','Seoyeon','Elin','Pedro','Rémi','Liam','Adriano','Thiago','Sergio','Andrés','Daniel','Takumi']
Original_List_of_Voices = ['Joanna**','Kendra','Kimberly','Salli','Ruth','Olivia','Kajal*','Amy**','Emma','Aria','Ayanda','Ivy','Joey','Matthew**','Stephen','Brian','Arthur','Justin','Kevin','Lupe**','Hiujin','Zhiyu','Léa','Gabrielle','Bianca','Ida','Ola','Camila','Vitória/Vitoria','Inês/Ines','Lucia','Mia','Hala*','Arlet','Laura','Suvi','Vicki','Hannah','Kazuha','Tomoko','Seoyeon','Elin','Pedro','Rémi','Liam','Adriano','Thiago','Sergio','Andrés','Daniel','Takumi']
Audio_Voice_Table = """Language and language variants,Rarity Weight (Higher the number means its more likely to be picked),Name/ID,Gender
...
Portuguese (Brazilian),15%,Vitória/Vitoria,Female
Portuguese (European),15%,Inês/Ines,Female
...
Spanish (Mexican),15%,Andrés,Male
...
Italian_Voices = ['Léa','Bianca','Lucia','Rémi','Adriano','Sergio']
