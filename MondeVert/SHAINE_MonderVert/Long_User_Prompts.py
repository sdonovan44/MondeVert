...
Test_Title_Summarize_FL = "Shane Donovan MondeVert Consulting and other Freelance Services"
...
Description: Let AI create unique art for you! Just provide a picture, description, or artist you like and let the MondeVert prompts and Python code do the rest. Every piece will be one-of-a-kind and sure to impress. 
...
Description: Need a personalized poem? Let AI do the work! Provide us with your specifications, and our MondeVert prompts and Python code will generate a beautiful and unique poem just for you. 
Price: $40 per set of 10 poems or 1 poem for $5 
Skills Required: Python programming, AI, creativity

- Service: AI-Generated Short Story
Description: Looking for an imaginative and captivating short story? Let AI do the writing for you! Just provide your specifications, and our MondeVert prompts and Python code will create a one-of-a-kind story that is sure to impress. 
...
- Developed and provided technical support for MondeVert.co, a website that promotes positivity and supports sustainable projects.
...
Persona_Special = """Have fun, use the reocurring characters in all 3 types of work in the results you provide"""
...
Persona_artist_Special = """Have fun, you should have a unique brand and style that makes your persona feel one of a kind but still relateable."""
...
Character_Task_add_on1 = """ When creating the {character} detaikls use the following {outline}  as a guide. Outline:###"""
Characters_Role = Short_Story_Role
Characters_Task ="""{Task}: ###Create 10-15 Main Characters and 10-20 Minor Characters for a short story/screenplay be creative and pick a diverse mix of characters, or if there is a specific time period or theme you are picking you can use names and characters that fit accordingly. Use the {Persona} you created to come up with the inspiration###"""
Characters_Special = """Have fun, be creative and follow the rules"""
...
Characters: ###{Name:{First Name Last Name}Age:{Age}|Voice:{Voice}|Personality:{Personality}|Home:{Current:{City State}|origin:{Country}}|Language:{Language}|Minor_Major_Role:Minor_Major_Role|Protaganist_Antagonist_Unknown:{Protaganist_Antagonist_Unknown}|Career:{Current:{Current Job}|Dream Job:{Dream Job}}|strengths:{strengths,strengths,strengths}|weakness:{weakness,weakness,weakness}|Background:{Background}}###"""


#Below is step 2
#****************************************************************
#Fist Outline of all detail;s
...
Episode by Episode Outline:
    Episode Specific Info: ###Episode Number{Episode #}| Episode Title:{Title}|Episode Length:{Episode Length}|Setting:{Setting}|mood:{mood}|Theme:{Theme}Narrative:{Narrative}|Point of view:{Point of view}|Language(s):{Language(s)}|Music:{genres:{song genre}|songs:{song by artist,song by artist}}|Specific Quotes:{'Quote' - Character}###
...
Episode Details:###
    Episode Number{Episode Number}| Episode Title:{Title}|Episode Length:{Episode Length}
    Setting:{Setting}
    mood:{mood}
    Theme:{Theme}
    Narrative:{Narrative}
    ...
    Language(s):{Language(s)}
    Music:{genres:{song genre}|songs:{song by artist,song by artist}}
    Characters in Episode:<comma_separated_list_with_short_summary_of_their_persona>
    Specific Quotes:{'Quote' - Character}###
