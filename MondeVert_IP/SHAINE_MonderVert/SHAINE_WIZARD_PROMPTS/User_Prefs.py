...
MondeVert_ArtPrompt_PictureBook2= "write a  short descriptive art prompt for an DALL-E (ai) artist to render a work of art for each {page} of the following picturebook. Use the details provided regarding {Illustration Details}  to come up with your prompt. Note: the art should appeal to kids and be clear what the image is even though it is animated or illustrated. The more clear the picture the better. It would also be ideal if you could match the  styule and tones of each prompt. For Following text you completed, For this task you are asked to Illustration a children's story. Pictures need to be family friendly and bright with positive tones.  Your prompt should have 1-2 art prompts created for each page each one separated by a '|' delimiter"
...
Translate_PictureBook_Line2 = "You are a master translator and children's writer able to take an english text and translate to [ "
Translate_PictureBook_Line4 = "Translate the following Text: ["
Translate_PictureBook_Line3 = "The text being translated is a [Children's story], use kid-friendly words that are short and simple trying to help them learn to read . I repeat, use appropriate language for children."
...
Test_Role_RE = "Maine Realtor/Broker who is the best teacher for passing the Maine (USA) real estate exam. You are easy to understand while being helpful and complete in your answers."
Test_Background_RE = "You are easy to understand while being helpful and complete in your answers. (The Study Guide should be equivalent of paying for a class and the teacher providing you with a notebook full of useful information) . The study guide you create will be 3-5+ pages worth of detailed notes followed by a 10 question quiz on the material"
Test_Task_RE = "Your {Task} is to Write me a Detailed Study guide with the full definitions of key terms, provide helpful information about the laws, the user should not have to do any further research after this request is complete, do not say what to study actually provide the details for each topic. Provide all of the details related to the Maine State Portion of the exam. As per the Maine Real Estate Commission provides a Candidate Handbook that includes a list of laws and regulations that you need to know for the exam. You can access the handbook here: 'https://home.pearsonvue.com/getattachment/abeb9965-3ffb-4f7b-98b4-57be2f2618e5/Maine%20Real%20Estate%20Candidate%20Handbook.aspx' that will enable me to pass the South Carolina State Exam, Provide easy to understand explanations of the most difficult concepts and have a list of the specific laws that you just need to memorize to pass the test; provide the full details needed to pass the test and answer all of the questions. Do not simply write the thing I need to study provide the full definition. Also provide the passing criteria and how to sign up for the test as an out of state resident with their MA real estate salesperson license. {Goal}: The study guide should be so informative and complete the user should be able to pass the Real Estate exam for Maine State after reviewing the text"
Test_Format_RE = "provide a high level summary with bullets of key information, there should be sub-bullets in order to fully define the key information and provide examples as well as any information neccesary to answer an exam question on the topic. After you provide bullets for the Maine State Exam, State by a paragraph or two explaining the top 15 most difficult concepts to understand and the neccasary information to explain the topics. Provide a ton of detail so I can learn from the study guide. Be sure to provide all neccesary information, its better to have more details rather than less as user's {Goal} is to pass the exam"
Test_Special_RE = "Source the latest information as of 2023, be complete in your analysis and focus on Maine's exam and not the Federal Exam. I repeat I do not want any information avbout the state exam"
Test_Title_RE = '2023 Maine Real Estate Exam'
...
Test_Background_ReSearch = "You are easy to understand while being helpful and complete in your answers. Provide any and all information that you can find on the following people/businesses:  Caroline Newcomb, maiden name Talbot from  Cambden ME originally and Richard Newcomb. They both were married and lived in Quincy and Milton,MA. Richard 'Dick' Newcomb was the son of a Bakery owner and learned about business at a young age as well as how to run a restaurant and bake food. He learned about what the  Newcombs Bakery, Mug n Muffin,Newcomb Farms. The couple met while Caroline was living in Wolloston, MA and Richard used to try to flirt with her friend. From right away Charline said Dick would be her husband. She took a job at his fathers baker, gramps was impressed with her work ethic and that impressed Dick/Richard. It wasn't long until they started dating and then were married. Their love was pure and eternal, she took care of him and he took care of her, they were a perfect match. They Had 6 children 3 boys and 3 girls in order of oldest to youngest Debbie, Rickie, Nancy, Danny, Carrie, David. David now runs the restaurant since Richard's passing. Richard had a sister Louise who started a successful apolstory business. Richard and his wife Caroline 'Charline' Newcomb started a company named Mug n Muffin the same year their daughter 'Carrie' Reid was born (1965). They would eventually open 27 total restaurants from Boston to Manomet and Richard would be known for all of his work with the quincy hospital, his ingenuity as a businessman bringing red trolleys to boston and also bringing the skillet breakfast to the north from florida. He would have the kids go through trash cans of the busy restaraunts he went by while the family was on vacation to see what was selling the most he was a true entrepaneur. They bought a beach house in Marshfield where their kids would enjoy summers with much freedom and even driving around in a Mug n Muffin van delivering muffins to local Marshfield,MA customers. As they got older they would spend winters in marco island florida. In the 1990s Mug n Muffin defranchised and Richard kept the 2 most profitable stores. Milton and Wolloston, they were rebranded as NEwcomb farms. Richards Widowed wife outlives him by over 20 years as she continues to go strong working continuously in the store and baking banana breads on her day off, she herself is a legend of Milton and anyone who has crossed her path. She is now back working at newcomb farms where she will continue to work until the day she dies, if that ever comes. I love that women as she is my grammie and best friend a true inspiration. As mentioned she has an interesting story as well, but for now I want to focus on the details I provided. Clean it up and combine it with anything you can find on the web for the names provided earlier. Do not go beyond 1/2 of the allowed tokens in your response try to be concise while telling the whole story. Caroline comes from humble begininnings where she would eat ketchup sandwiches and where she did not have a winter coat until she won a contest to see Bop Hope and Bing Crosbey but thats another story. She loves to mention she was a great athlete which came from her father who unfortunately died before she was born. Charline back in Maine won a fre throw shooting contest and I have seen her play ping pong personally at age 80 and I honestly believe she was a great athlete! She was poor and living with her mother when she overheard her mom say she could not move to Georgia with her Caroline's mother's sister because she was taking care of Caroline. That is when Charline jumped on a bus and found an apartment in wolloston,ma where the rest is history (Fate took over). Additional details: love story about the story of Caroline 'Charline' Newcomb going from her humble beginnings of Cambden Maine to being the unofficial 'Mayor of Milton'. She is adored by all who come and are graced with her presence,  with her right hand man and lover of her life Richard 'Dick' Newcomb. Talk about their business they created and the family they raised. Be honest and talk about times not always being easy but love getting them through it. Mention that charline's grandkids, children, family and friends adore her. She is an old time gal who is old fasioned but still up to date in current affairs 'she never smelt like old people a day in her life' she is a great cook, amazing baker and a perfect grammie to Shane Donovan (me) and all of her grandkids. We are all so lucky to have her and I want this to show how she is a powerful woman who made her way from rags to riches and has stayed humble and loving throughout. Make her the hero of this story. Dick is a stern businessman who only has a soft side for his lovely wife Charline. His kids know he means business and he demands peace when he is home from work. He was a great man who was very wise and always helped the community as well as his family and those that worked for him. That doesnt mean he was a jolly old man, he was tough but fair he knew how to make 1/2 pund look like a pound but you always left satisfied."
...
Test_Format_ReSearch2 = "Use proper MLA citing at the end of the novel/short story. Find quotes if you can and/or positive reviews from yelp etc. Really do some deep research to find information about the origin of Newcomb Farms Restauraunt in Milton, MA (and Mug N Muffin) including the full history and anything you can get about the owners. Final Format: {Summary of details so far|What else needs to be provided for the story to be complete| 100 Interview Questions for Caroline Newcomb|100 Interview Questions for children relatives and remaingin friends, grandkids as well|100 interview questions for people who worked at newcomb farms, experience of working there as well as how it was working with Caroline|100 questions for patrons of restaurants, includes 3 generations of grandkids and grandparents enjoying a family time breakfast|Other questions|Other details to gather|MLA Citations of current online references}"
Test_Task_ReSearch2 = "Your {Task} is to Write a plan for how to shoot the documentary describing this story. Tell me what interview questions to ask based on the details provided. Come up with 100 questions per person to ask about this topic I can share and people can help fill in the information. What questions should I ask? What information is worth getting? Be detailed and help me get enough information to cover a 15 minute documentary. I will be interviewing first hand witnesses as well as patrons of the store. Try to group the questions and provide what the category is and/or the general idea of the questions being asked and to whom."


#Test_Format_ReSearch3 = "Use proper MLA citing at the end of the novel/short story. Find quotes if you can and/or positive reviews from yelp etc. Really do some deep research to find information about the origin of Newcomb Farms Restauraunt in Milton, MA (and Mug N Muffin) including the full history and anything you can get about the owners. Final Format: Title:Title|Characters|Plot|Arc Plot|Foreshadowing|Red herring|Music|Outline|Book:Chapter:Text (include narration, actions and dialog)}"
Test_Format_ReSearch3 = "Use proper MLA citing at the end of the novel/short story. Find quotes if you can and/or positive reviews from yelp etc. Really do some deep research to find information about the origin of Newcomb Farms Restauraunt in Milton, MA (and Mug N Muffin) including the full history and anything you can get about the owners. Final Format: Title:Title|Text (include narration, actions and dialog. Have chapter names in the text, make sure it is 5-10 pages long add dialog between Richard and Carloline. Dramatize the defranchising. Make a story out of the facts provided make it interesting for the reader to read. It is a work of fiction but it is inspired and based off the details I have provided)}"
Test_Task_ReSearch3 = "Your {Task} is to Write a fully written 5-10 page love story with multiple chapters describing the story of Caroline 'Charline' Newcomb going from her humble beginnings of Cambden Maine to being the Mayor of Milton with her right hand man and lover of her life Richard 'Dick' Newcomb. Talk about their business they created and the family they raised. Try to keep the facts based on details I have provided do not make changes. Dialog can be made up but it should fit the details provided and also fit the characters as described"
...
ArtistBio_SongArtistRR= 'I want you to write a detailed description of the artist (styles etc. and what the song they want to write is about. Talk about the subject of the song, tone, melody description and other music theory concepts. Include the key and BPM the song is supposed to be performed at.Use the following details to create a unique and relateable persona for your role play.   Provide specific quotes for the song to use and also describe  describe how you typically source your inspiration and include your influences and other music theory ideas/concepts. Come up with your own words. For your reference, The Artist bio:  '
...
Title_SongArtistsRR= "Create a short abstract title for the following song:"
...
Song_Prompt_SongArtistsRR =  "Write a new and unique song that consists of Several lyrics to sample (provide song name and artist), a bridge and a chorus.  Utilize proper rhyme schemes and writing styles. Fit your artist's genre and  respective styles. Base the song off the following Subject: "
...
#This is SHane's Bio I can rename in the future so I do not need to keep changing
