...
from MondeVert_IP.SHAINE_MonderVert.Utilities import ShakesBot as s, DoNotCommit as DNC
from MondeVert_IP.SHAINE_MonderVert.SHAINE_WIZARD_PROMPTS import Common_Sayings as cs, User_Prefs as up
...
############################################################################################################################################################################################################################
    ...
    def makeArt(self, Prompt = ''):
        ...
        if not os.path.exists("Testing_Files/Utilities/images"):
            os.mkdir("Testing_Files/Utilities/images")
...
#Blog Make Art Live mode
    def MakeArtLive(self):
        ...
        DigitalAssist.NamePoemSavePoem(self, Script1, [], '', 'Shane Donovan - MondeVert_IP CEO', title=Title + '_' + self.current_time22, FolderPath=up.AI_Live_Art_Path,ArtType='MondeVert_IP Podcast with Live Art')
