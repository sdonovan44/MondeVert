...
#MondeVert_Promo
audio_new = r"A:\MondeVert Productions\SHAINE - MondeVert AI Assistant\SHAINE_Requests\Beta - Testing\AI AudioBooks\The title of the data is Broken Identities\The title of the data is Broken Identities.txt"
audio_File_name = 'Broken Identities'
