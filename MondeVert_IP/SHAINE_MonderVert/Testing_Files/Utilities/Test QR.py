...
if __name__ == '__main__':
    ...
    #                             name = 'Donovan - MondeVert_IP',
    #                              displayname='Shane',
    #                             org=('MondeVert_IP, CEO | SUCCESS! Real Estate, Realtor'),
    #                                 phone = '7819748735',
    ...
    #                              memo = ('My Name is Shane Donovan,  I am CEO of my own company, MondeVert_IP. I am also a Realtor in MA going for my license in South Carolina.')
    #                              )
    #
    #
    ...
    qrcode = segno.make('https://square.link/u/x1mSmYjS')
    img = qrcode.to_pil(scale=4, dark='purple', data_dark='red',
                       data_light='pink')
    img.save('A:\Amini Amor\QR Code and ads\squareDonatepage.png')
