...
class PoemBot:
    ...
    def GreekWords(self):
        ...
        # load document
        in_filename = '../Testing_Files/Utilities/republic_clean.txt'
        ...
        out_filename = '../Testing_Files/Utilities/republic_sequences.txt'
        PoemBot.save_doc(self,sequences, out_filename)

        # load
        in_filename = '../Testing_Files/Utilities/republic_sequences.txt'
        doc = PoemBot.load_doc(self,in_filename)
        lines = doc.split('\n')
        ...
        dump(tokenizer, open('../Testing_Files/Utilities/tokenizer.pkl', 'wb'))
    ...
    def generateGreek(self):
        ...
        # load the model
        model = load_model('../Testing_Files/Utilities/model_Greek.h5')

        # load the tokenizer
        tokenizer = load(open('../Testing_Files/Utilities/tokenizer.pkl', 'rb'))
